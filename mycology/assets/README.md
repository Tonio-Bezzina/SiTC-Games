...
This library implements `../MYCOLOGY_ASSETS.md` for The Mycology Journey. It combines eight original generated PNG illustrations with twenty-two deterministic repository-native SVGs. Interface copy, case data, labels, choices, focus, feedback, and correctness remain live HTML/CSS.

## Visual direction and continuity

The raster art uses a friendly semi-realistic 3D educational style with soft cool upper-left lighting, clean rounded materials, and the SiTC navy, cyan, teal, white, and gold palette. Dr Mira’s neutral, pointing, and success sprites share the same identity, clothing, 1024-square canvas, scale, and `(512,930)` foot anchor. Mission backgrounds retain wide empty overlay areas.
...
- `mission-2/`: five fictional patient/body-site cards and five specimen objects.
...
- `contact-sheets/`: labelled shared/background, mission, and state-family review sheets.
...
The checker enforces manifest/filesystem parity, stable lowercase naming, unique IDs, real dimensions/bytes/hashes, PNG alpha expectations, SVG viewBox/title presence, no scripts/external URLs, registered Dr Mira canvases/anchors, and contact-sheet presence.

Visual review on 20 September 2026 inspected all eight PNGs at full resolution and all SVGs through labelled contact sheets. The three state families were compared side by side for identity, scale, canvas, colour, morphology, and answer bias. No accidental text, logos, real identifiers, malformed equipment, open-culture handling, or uncorrected scientific continuity defects remain.
