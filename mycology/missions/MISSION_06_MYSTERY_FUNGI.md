...
The player first chooses colony colour, then conidial-head clue, then species. The mystery follows the first path. Every card can toggle between colony and microscopic views.
